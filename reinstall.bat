...
set confhome=https://raw.githubusercontent.com/smithwhere/reinstall/main
set confhome_cn=https://raw.githubusercontent.com/smithwhere/reinstall/main
rem set confhome_cn=https://www.ghproxy.cc/https://raw.githubusercontent.com/smithwhere/reinstall/main
